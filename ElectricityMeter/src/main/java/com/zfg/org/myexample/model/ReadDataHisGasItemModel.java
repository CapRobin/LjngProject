...
//    购气次数远程  ——CrgCntRmt
    ...
    public  void of(JSONObject data) throws JSONException {
        this.setSTMTCONSU(data.getString("AXDY"));//正向有功CONSU
        this.setCRGBAL(data.getString("AXDL"));//反向有功
        this.setCRGCNTLCL(data.getString("ZXYGDL"));
        this.setCRGCNTRMT(data.getString("FXYGDL"));
        this.setDATE_TIME(data.getString("ZXWGDL"));
        this.setGASCONSUMPTION(data.getString("FXWGDL"));
        this.setSURPLUSAMTLCL(data.getString("DATE_TIME"));
