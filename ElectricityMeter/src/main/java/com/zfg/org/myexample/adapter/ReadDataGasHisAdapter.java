...
public class ReadDataGasHisAdapter extends MBaseAdapter {
    ...
    protected void holderView(View convertView, Object itemObject) {
        ...
        holder.GasConsumption.setText("电压 " + dto.getSTMTCONSU()+"V");
        holder.StmtConsu.setText("电流 " + dto.getCRGBAL()+"A");
        holder.CrgBal.setText("正向有功电能 " + dto.getCRGCNTLCL() +"kWh");
        holder.SurplusAmtLcl.setText("反向有功电能 " + dto.getCRGCNTRMT() +"kWh");
        holder.SurplusAmtRmt.setText("正向无功电能 " + dto.getDATE_TIME() +"kWh");
        holder.CrgCntLcl.setText("反向无功电能 " + dto.getGASCONSUMPTION() +"kWh");
        holder.CrgCntRmt.setText("时间 " + dto.getSURPLUSAMTLCL() +"次");
