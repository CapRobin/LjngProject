 ...
 *
 * Name：WaterMeterActivity
 * Describe：水表数据查询
 * Date：2018-03-28 10:57:28
 * Author: CapRobin@yeah.net
 *
 */
public class WaterMeterActivity extends BasicActivity {
    private List<String> showListData1, showListData2 = null;
    private static String sbCheckItemType[] = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sbCheckItemType = getResources().getStringArray(R.array.sbCheckItemType);
        //加载数据
        setData();
    }
    ...
    private void setData() {
        ...
        // 构造数据
        for (int i = 0; i < sbCheckItemType.length; i++) {
            showListData1.add(sbCheckItemType[i]);
        }
        for (int i = 0; i < 20; i++) {
