 ...
 */
public class RecordsQueryActivity_bak extends BasicActivity implements View.OnClickListener,RadioGroup.OnCheckedChangeListener{
...
//      界面资源
        setContentView(R.layout.activity_records_query_bak);
