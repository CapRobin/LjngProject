...
// KEEP INCLUDES END
/**
 * Entity mapped to table favorate.
 */
public class Favorate {
    ...
    public Favorate(Long id) {
        this.id = id;
    }

    public Favorate(Long id, String thumbnail, String title, String author, String summary, long day, String content, String server_mid) {
        this.id = id;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getFavorateDao() : null;
    }
