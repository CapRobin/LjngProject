 ...
 *
 * Name：HeatMeterActivity
 * Describe：热表数据查询
 * Date：2018-03-28 10:57:58
 * Author: CapRobin@yeah.net
 *
 */
public class HeatMeterActivity extends BasicActivity {
    private List<String> showListData1, showListData2 = null;
    private static String rbCheckItemType[] = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_heat_meter);
        ...
        rbCheckItemType = getResources().getStringArray(R.array.rbCheckItemType);
        //加载数据
        setData();
    }
    ...
    private void setData() {
        ...
        // 构造数据
        for (int i = 0; i < rbCheckItemType.length; i++) {
            showListData1.add(rbCheckItemType[i]);
        }
        for (int i = 0; i < 20; i++) {
    ...
    private void closeInputMethod() {
        ...
        if (isOpen) {
            imm.hideSoftInputFromWindow(HeatMeterActivity.this.getCurrentFocus().getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);
        }
