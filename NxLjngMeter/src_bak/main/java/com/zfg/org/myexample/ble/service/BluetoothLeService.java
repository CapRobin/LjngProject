...
package com.zfg.org.myexample.ble.service;
...
import com.zfg.org.myexample.ble.BLEProfileDataParserClasses.BloodPressureParser;
import com.zfg.org.myexample.ble.BLEProfileDataParserClasses.CSCParser;
import com.zfg.org.myexample.ble.BLEProfileDataParserClasses.CapSenseParser;
import com.zfg.org.myexample.ble.BLEProfileDataParserClasses.DescriptorParser;
import com.zfg.org.myexample.ble.BLEProfileDataParserClasses.GlucoseParser;
import com.zfg.org.myexample.ble.BLEProfileDataParserClasses.HRMParser;
import com.zfg.org.myexample.ble.BLEProfileDataParserClasses.HTMParser;
import com.zfg.org.myexample.ble.BLEProfileDataParserClasses.RGBParser;
import com.zfg.org.myexample.ble.BLEProfileDataParserClasses.RSCParser;
import com.zfg.org.myexample.ble.BLEProfileDataParserClasses.SensorHubParser;
import com.zfg.org.myexample.ble.Utils.Constants;
import com.zfg.org.myexample.ble.Utils.GattAttributes;
import com.zfg.org.myexample.ble.Utils.UUIDDatabase;
...
public class BluetoothLeService extends Service {
     ...
     */
    public final static String ACTION_GATT_CONNECTED = "com.zfg.org.myexample.le.ACTION_GATT_CONNECTED";
    //
    public final static String ACTION_GATT_DISCONNECTED = "com.zfg.org.myexample.le.ACTION_GATT_DISCONNECTED";
    //
    public final static String ACTION_GATT_DISCONNECTED_CAROUSEL = "com.zfg.org.myexample.le.ACTION_GATT_DISCONNECTED_CAROUSEL";
    //
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.zfg.org.myexample.le.ACTION_GATT_SERVICES_DISCOVERED";
    //
    public final static String ACTION_DATA_AVAILABLE = "com.zfg.org.myexample.le.ACTION_DATA_AVAILABLE";
    //
    public final static String ACTION_GATT_CHARACTERISTIC_ERROR = "com.zfg.org.myexample.le.ACTION_GATT_CHARACTERISTIC_ERROR";
    //
    public final static String ACTION_GATT_DESCRIPTORWRITE_RESULT = "com.zfg.org.myexample.le.ACTION_GATT_DESCRIPTORWRITE_RESULT";
    //  写成功
    public final static String ACTION_GATT_CHARACTERISTIC_WRITE_SUCCESS = "com.zfg.org.myexample.le.ACTION_GATT_CHARACTERISTIC_SUCCESS";

    /**
     * Connection status Constants
     */
    public static final int STATE_DISCONNECTED = 0;
    private final static String ACTION_GATT_DISCONNECTING = "com.zfg.org.myexample.le.ACTION_GATT_DISCONNECTING";
        ...
        public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                // Model number read value
                    ...
                    mBundle.putString(Constants.EXTRA_MONS_VALUE, Utils.getModelNumberString(characteristic));
                }
                // Serial number read value
                else if (charUuid.equals(UUIDDatabase.UUID_SERIAL_NUMBER_STRING)) {
                    mBundle.putString(Constants.EXTRA_SNS_VALUE, Utils.getSerialNumberString(characteristic));
                }
                // Hardware revision read value
                else if (charUuid.equals(UUIDDatabase.UUID_HARDWARE_REVISION_STRING)) {
                    mBundle.putString(Constants.EXTRA_HRS_VALUE, Utils.getHardwareRevisionString(characteristic));
                }
                // Firmware revision read value
                else if (charUuid.equals(UUIDDatabase.UUID_FIRWARE_REVISION_STRING)) {
