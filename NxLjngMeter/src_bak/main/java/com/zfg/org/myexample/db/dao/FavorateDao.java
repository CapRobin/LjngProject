...
public class FavorateDao extends AbstractDao<Favorate, Long> {
    ...
    /**
     * Properties of entity Favorate.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property Server_mid = new Property(7, String.class, "server_mid", false, "SERVER_MID");
    };

    private DaoSession daoSession;


    public FavorateDao(DaoConfig config) {
        super(config);
    }
    
    public FavorateDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'favorate' (" + //
                ...
                "'SERVER_MID' TEXT NOT NULL );"); // 7: server_mid
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'favorate'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Favorate entity) {
        stmt.clearBindings();
        ...
        stmt.bindString(8, entity.getServer_mid());
    }

    @Override
    protected void attachEntity(Favorate entity) {
    ...
    /** @inheritdoc */
    @Override
    public Favorate readEntity(Cursor cursor, int offset) {
        Favorate entity = new Favorate( //
            ...
            cursor.getString(offset + 7) // server_mid
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Favorate entity, int offset) {
        ...
        entity.setServer_mid(cursor.getString(offset + 7));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Favorate entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Favorate entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
