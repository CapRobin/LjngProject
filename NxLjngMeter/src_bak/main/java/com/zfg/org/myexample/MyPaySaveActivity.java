 ...
 */
public class MyPaySaveActivity extends BasicActivity implements View.OnClickListener {
    ...
    private MyPaySaveActivity activity;
    private Preference preference;

    private CallBack dataCallback;

    private CallBack weipaydataCallback;

    private CallBack alipaydataCallback;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        activity = (MyPaySaveActivity) context;
...
//            SystemAPI.query_readdata_his(map, dataCallback);
    ...
    private void alipayinitCallBack() {
        alipaydataCallback = new CallBack() {
            @Override
            public void callback(String json) {
...
//            SystemAPI.query_readdata_his(map, dataCallback);
    ...
    private void weipayinitCallBack() {
        weipaydataCallback = new CallBack() {
            @Override
            public void callback(String json) {
                setDialogLabel("获取订单完成");
//                loading.hide();
